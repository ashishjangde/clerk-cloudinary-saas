...
type SocialFormatType = keyof typeof socialFormats;

export default function Page() {
  const [uploadedImage, setUploadedImage] = useState<string | null>(null);
  const [selectedFormat, setSelectedFormat] = useState<SocialFormatType>("Instagram Square (1:1)");
            ...
            <div className="mt-6">
              ...
              <div className="form-control">
                <select
                  ...
                  onChange={(e) =>
                    setSelectedFormat(e.target.value as SocialFormatType)
                  }
                >
